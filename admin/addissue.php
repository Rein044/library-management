    ...
    <div class="disp1">
        ...
        <form action="" method="post">
            ...
            <div class="addiss">
                ...
                <input class="inn" type="text" name="stid" placeholder="Exp: SID27" required>
                <div class="student-info"></div>
            </div>
            <div class="addiss">
                <label for="issu">ISBN or Bookname:</label><br>
                <input class="inn" type="text" name="isbnname" placeholder="Enter the Book Name or the ISBN" required>
            </div>
    ...
    $("input[name='stid']").on('input', function () {
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                // Check if the input is empty and hide the message accordingly
                if (studentId.trim() === '') {
                    $(".student-info").hide();
                } else {
                    $(".student-info").show();
