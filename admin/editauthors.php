...
<body>
    ...
    <div class="mautor">
        <p>Edit Book</p>
        <?php
        include "toeditauthors.php";
        ?>
        


        <form id="editauthor" method="post" action="updateauthor.php">
    <div class="eau">
        <label for="authorName">Author Name:</label><br>
        <input type="text" id="authorName" name="authorName" value="<?php echo $authorInfo['authorname']; ?>"><br>
        <input type="hidden" id="authorID" name="authorID" value="<?php echo $authorInfo['id']; ?>" readonly>
